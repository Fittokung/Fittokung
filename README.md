...
<h3 align="center">Computer Engineering graduate specializing in Software Testing with hands-on experience in manual and automated testing, requirement analysis, and backend validation. Currently working as a Software Tester, with a strong interest in bridging business requirements and technical implementation, aiming to grow into a Business Analyst role.</h3>

---

### 🌱 Experience

- **Software Tester** at EDVISORY tech *(Present)*
- **Software Tester Intern** (5-month cooperative education) at Nextate Technology
- **Teacher Assistant** in Embedded System Laboratory and Microprocessor classes
